...
let browesers=["chrome","firefox","edge"];// Creating Arrays// Array literal (preferred)
let testResults=["pass","fail","pass","pass","fail","skip"]
let mixed=[1,"hello",true,null];//JS arrays hold any data type
